...
5. Esta nos pedira lo siguiente:
    ...
    ![metamask 4](/images/metamask_4.png)

6. Le damos en Switch to testNet, a lo que vemos lo siguiente

    ![metamask 5](/images/metamask_5.png)
